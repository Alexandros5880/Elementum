...
Tags: block, blocks, gutenberg blocks, wordpress blocks, editor blocks
...
2. Here, search for 'Di Blocks'
3. Now click on 'Install' and then 'Activate'

= Manual Installation =
<ol>
	<li>Download plugin zip file from : https://wordpress.org/plugins/di-blocks/</li>
...
<ol>
	<li>Open edit screen of a page or post.</li>
	<li>Click on (+) add new block icon.</li>
	<li>Click on Di Blocks category.</li>
	<li>Click on needed block.</li>
</ol>

= I need support =
Please create support topic <a href='https://wordpress.org/support/plugin/di-blocks/'>Here</a>
