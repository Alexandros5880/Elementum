...
if ( ! function_exists( 'koromo_archive_title' ) ) {
	add_action( 'koromo_archive_title', 'koromo_archive_title' );
	/**
	 * Build the archive title
	 *
	 */
	function koromo_archive_title() { ?>
		<header class="page-header<?php if ( is_author() ) echo ' clearfix';?>">
			<?php
			/**
			 * koromo_before_archive_title hook.
			 *
			 */
			do_action( 'koromo_before_archive_title' );
			?>
			...
			<?php
			/**
			 * koromo_after_archive_title hook.
			 *
			 */
			do_action( 'koromo_after_archive_title' );
			...
			/**
			 * koromo_after_archive_description hook.
			 *
			 */
			do_action( 'koromo_after_archive_description' ); ?>
		</header><!-- .page-header -->
		<?php
	}
}

if ( ! function_exists( 'koromo_filter_the_archive_title' ) ) {
	add_filter( 'get_the_archive_title', 'koromo_filter_the_archive_title' );
	/**
	 ...
	 */
	function koromo_filter_the_archive_title( $title ) {
		if ( is_category() ) {
