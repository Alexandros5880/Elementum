...
$navigation_active = ( 'nav-left-sidebar' == koromo_get_navigation_location() ) ? true : false;
...
?>
<div id="left-sidebar" itemtype="https://schema.org/WPSideBar" itemscope="itemscope" <?php koromo_left_sidebar_class(); ?>>
	<div class="inside-left-sidebar">
		<?php
		/**
		 * koromo_before_left_sidebar_content hook.
		 *
		 */
		do_action( 'koromo_before_left_sidebar_content' );
		...
		/**
		 * koromo_after_left_sidebar_content hook.
		 *
		 */
		do_action( 'koromo_after_left_sidebar_content' );
		?>
