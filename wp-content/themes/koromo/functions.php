...
define( 'KOROMO_VERSION', '1.1.0' );

if ( ! function_exists( 'koromo_setup' ) ) {
	add_action( 'after_setup_theme', 'koromo_setup' );
	/**
	 * Sets up theme defaults and registers support for various WordPress features.
	 *
	 */
	function koromo_setup() {
		// Make theme available for translation.
		load_theme_textdomain( 'koromo' );
		...
		register_nav_menus( array(
			'primary' => __( 'Primary Menu', 'koromo' ),
		) );

		/**
		 * Set the content width to something large
		 * We set a more accurate width in koromo_smart_content_width()
		 */
...
define('KOROMO_THEME_URL','https://wpkoi.com/koromo-wpkoi-wordpress-theme/');
define('KOROMO_WPKOI_AUTHOR_URL','https://wpkoi.com/');
define('KOROMO_WPKOI_SOCIAL_URL','https://www.facebook.com/wpkoithemes/');
define('KOROMO_WORDPRESS_REVIEW','https://wordpress.org/support/theme/koromo/reviews/?filter=5');
define('KOROMO_DOCUMENTATION','https://wpkoi.com/docs/');