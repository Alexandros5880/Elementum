...
//----------------------Footer Columns 1----------------------------------
	$wp_customize->add_setting('complete[foot_cols1_title]', array(
		'type' => 'option',
		'default'	=> __('SKT Martial Arts Lite','complete'),
...
$wp_customize->add_setting('complete[foot_cols1_content]', array(
	'type' => 'option',
	'default' => 'Pellentesque placerat urna eu iaculis dictum. Donec bibendum pellentesq risus, commodo dapibus eros maximus quis. Curabitur at finibus nulla, eget aliqua quam bibendum pellentesq risus.[space height="20"][social_area]
...
$wp_customize->add_setting('complete[foot_cols3_content]', array(
	'type' => 'option',
	'default' => '[footermenu menu="service"]',
	'sanitize_callback' => 'wp_kses_post',
	'transport' => 'postMessage',
) );
