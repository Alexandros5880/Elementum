<?php 
/**
 * The Custom Style for SKT Martial Arts Lite
 *
...
/*-----------------------------COLORS------------------------------------*/
		...
		.slider-main .nivo-caption .slidebtn{ background-color:<?php echo $complete['sldbtn_color_id']; ?>;}	

		.slider-main .nivo-caption .slidebtn a{color:<?php echo $complete['sldbtntext_color_id']; ?>; }	
		.slider-main .nivo-caption .slidebtn:hover{background-color:<?php echo $complete['sldbtn_hvcolor_id']; ?>; }

		.slider-main .nivo-caption .slidebtn a:hover{ color:<?php echo $complete['sldbtn_hvtextcolor_id']; ?>;}
		...
		.bxslider li{background-color:<?php echo $complete['testimonialbox_color_id']; ?>; box-shadow:5px -5px 15px <?php echo $complete['testimonialbox_border_color']; ?>;}	
		...
		#topmenu ul li.appointment-btn{background-color: <?php echo $complete['menutxt_color_id'] ?>; }
		#topmenu ul li.appointment-btn:hover{background-color: <?php echo $complete['menutxt_color_id'] ?>;}
