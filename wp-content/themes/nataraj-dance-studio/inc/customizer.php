...
function nataraj_dance_studio_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('nataraj_dance_studio_show_site_title',array(
       'default' => true,
       'sanitize_callback'	=> 'sanitize_text_field'
    ));
    $wp_customize->add_control('nataraj_dance_studio_show_site_title',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Site Title','nataraj-dance-studio'),
       'section' => 'title_tagline'
    ));

    $wp_customize->add_setting('nataraj_dance_studio_show_tagline',array(
       'default' => true,
       'sanitize_callback'	=> 'sanitize_text_field'
    ));
    $wp_customize->add_control('nataraj_dance_studio_show_tagline',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Site Tagline','nataraj-dance-studio'),
       'section' => 'title_tagline'
    ));
		...
		$manager->add_section(
			new Nataraj_Dance_Studio_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'  => esc_url( 'https://www.luzuk.com/product/dance-studio-wordpress-theme/' ),
				)
			)
		);
	}
